...
|[](comments)           | Tue, Jan 17   | "Comment in Moodle"   |
...
```{Note}
Teams of two students have to use a regression model; teams of three students need to use a regression model as well as a classification model.
```
